...
entry start
start:					!! Now, program starts at 0x7C00
...
! the bootblock:
	...
	jmpi	0,SETUPSEG	!! jump to 0x9020:0 where setup starts
...
!! At this time, SS:SP point to 0x9000:FF00.
read_it:
	mov ax,es
	test ax,#0x0fff
...
rp_read:
	...
	cmp ax,#ENDSEG		! have we loaded all yet?
					!! ENDSEG == 0x1000+0x3000
	jb ok1_read
	ret
ok1_read:
	seg cs
	mov ax,sectors		!! number of sectors in every track
	sub ax,sread
	mov cx,ax
	shl cx,#9
	add cx,bx
